...
{nested_forms}[https://github.com/ryanb/nested_form] added support for the only thing this fork was adding.
You can now use the <tt>wrapper</tt> option with <tt>false</tt> to disable wrapping the fields in a wrapper div.
See {this commit}[https://github.com/ryanb/nested_form/commit/e866f4f2099d97106808d4a70b0aa0c4f3db4b56]
